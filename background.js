...
【R】提案（Recommendation）
- 医師に対してマイルドなトーンで記載する。強い提案や指示的な表現は避け、医師の判断を尊重する姿勢で書く
- 処方に問題がある場合でも、「ご検討いただければ幸いです」「ご確認いただけますでしょうか」など柔らかい表現を使う
- 継続服用中の注意点や観察ポイントがあれば、医師にご指示を仰ぐ形で記載する
  （例：「継続服用中の指示や観察ポイントなどがあればご指示ください。」）
  （例：「○○について、先生のご見解をお聞かせいただければ幸いです。」）
  （例：「○○の点が気になりましたので、ご確認いただけますでしょうか。」）
- 薬学的な懸念がある場合は情報提供の形で伝え、最終判断は医師に委ねる表現にする
  （例：「○○の可能性も考えられますので、ご参考までにお伝えいたします。」）
...
- R: 「現行処方の継続で問題ないと考えます。継続服用中の指示や観察ポイントなどがあればご指示ください。」のような形で記載する
